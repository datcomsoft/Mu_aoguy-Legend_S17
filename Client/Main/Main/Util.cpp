...
void Xor::BMD(BYTE * info, int Size)
{
	static const BYTE Key_1[KEY_SIZE_1]				= { 0xFC, 0xCF, 0xAB };
...
void Xor::Byte3(char * info, int Size)
{
	static const BYTE Key_1[KEY_SIZE_1]				= { 0xFC, 0xCF, 0xAB };
...
void Xor::LangXor(char * info, int Size, WORD key)
{
	static const BYTE Key_1[KEY_SIZE_1] = { 0xFC, 0xCF, 0xAB };
...
int Xor::Byte16(char * Source, char * Dest, int size)
{
	static const BYTE Key_2[KEY_SIZE_2]				= { 0xD1, 0x73, 0x52, 0xF6, 0xD2, 0x9A, 0xCB, 0x27, 0x3E, 0xAF, 0x59, 0x31, 0x37, 0xB3, 0xE7, 0xA2 };
	static const DWORD KEY_1							= 94;
...
void Xor::Byte20(char * src, char * dst, int size)
{
	static const BYTE Key_3[KEY_SIZE_3]				= { 0xD1, 0x73, 0x52, 0xF6, 0xD2, 0x9A, 0xCB, 0x27, 0x3E, 0xAF, 0x59, 0x31, 0x37, 0xB3, 0xE7, 0xA2 };
...
{
	static const BYTE Key_Custom[KEY_SIZE_CUSTOM]		= { 0xF1, 0x10, 0x23, 0x66, 0xAB };
...
int Xor::Byte16New(char * Source, char * Dest, int size)
{
	static const BYTE Key_2[KEY_SIZE_2]				= { 0xD1, 0x73, 0x52, 0xF6, 0xD2, 0x9A, 0xCB, 0x27, 0x3E, 0xAF, 0x59, 0x31, 0x37, 0xB3, 0xE7, 0xA2 };
	static const DWORD KEY_1							= 94;
